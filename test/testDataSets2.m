...
function test_ex_spm_HRF_informed_basis()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_HRF_informed_basis.nidm.zip', [data_path, filesep, 'temp.zip']);
...
function test_ex_spm_conjunction()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_conjunction.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_contrast_mask()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_contrast_mask.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_default()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_default.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_full_example001()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_full_example001.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_group_ols()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_group_ols.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_group_wls()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_group_wls.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_partial_conjunction()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_partial_conjunction.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_temporal_derivative()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_temporal_derivative.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_thr_clustfwep05()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_thr_clustfwep05.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_thr_clustunck10()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_thr_clustunck10.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_thr_voxelfdrp05()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_thr_voxelfdrp05.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_thr_voxelfwep05()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_thr_voxelfwep05.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_ex_spm_thr_voxelunct4()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/ex_spm_thr_voxelunct4.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_con_f_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_con_f_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_contrast_mask_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_contrast_mask_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_default_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_default_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_full_examples001_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_full_examples001_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_gamma_basis_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_gamma_basis_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_gaussian_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_gaussian_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_group_btw_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_group_btw_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_group_ols_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_group_ols_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_group_wls_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_group_wls_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_hrf_fir_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_hrf_fir_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_hrf_gammadiff_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_hrf_gammadiff_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_thr_clustfwep05_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_thr_clustfwep05_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
...
function test_fsl_thr_voxelfwep05_130()
    ...
    if(~exist(data_path, 'dir'))
        mkdir(data_path);
        urlwrite('http://neurovault.org/collections/2210/fsl_thr_voxelfwep05_130.nidm.zip', [data_path, filesep, 'temp.zip']);
        unzip([data_path, filesep, 'temp.zip'], [data_path, filesep]);
    end
    delete_html_file(data_path);
