...
function test_fsl_con_f_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_con_f_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_con_f_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_contrast_mask_130.nidm
function test_fsl_contrast_mask_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_contrast_mask_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_contrast_mask_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_default_130.nidm
function test_fsl_default_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_default_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_default_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_full_examples001_130.nidm
function test_fsl_full_examples001_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_full_examples001_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_full_examples001_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_gamma_basis_130.nidm
function test_fsl_gamma_basis_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_gamma_basis_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_gamma_basis_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_gaussian_130.nidm
function test_fsl_gaussian_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_gaussian_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_gaussian_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_group_btw_130.nidm
function test_fsl_group_btw_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_group_btw_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_group_btw_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_group_ols_130.nidm
function test_fsl_group_ols_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_group_ols_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_group_ols_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_group_wls_130.nidm
function test_fsl_group_wls_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_group_wls_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_group_wls_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_hrf_fir_130.nidm
function test_fsl_hrf_fir_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_hrf_fir_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_hrf_fir_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_hrf_gammadiff_130.nidm
function test_fsl_hrf_gammadiff_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_hrf_gammadiff_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_hrf_gammadiff_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_thr_clustfwep05_130.nidm
function test_fsl_thr_clustfwep05_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_thr_clustfwep05_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_thr_clustfwep05_130.nidm.zip'), 'All');
end

%Test viewer displays fsl_thr_voxelfwep05_130.nidm
function test_fsl_thr_voxelfwep05_130()
    data_path = fullfile(fileparts(mfilename('fullpath')),'..','data','fsl_thr_voxelfwep05_130.nidm.zip');
    delete_html_file(strrep(data_path, '.zip', ''));
    nidm_results_display(fullfile(fileparts(mfilename('fullpath')), '..', 'data','fsl_thr_voxelfwep05_130.nidm.zip'), 'All');
end
